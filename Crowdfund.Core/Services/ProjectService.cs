    ...
    public class ProjectService:IProjectService
    {
        ...
        public IQueryable<Project> SearchTrendingProjects()
        {
            return context_.Set<Project>()
                .Include(a => a.Media)
                .OrderByDescending(u => u.CurrentFund/u.TotalFund).Take(4);     //mporoume na dialeksoume kai allo metric edo
        }
        ...
        public IQueryable<Project> SearchLatestProjects()
        {
            return context_.Set<Project>()
                .Include(a => a.Media)
                .OrderByDescending(u => u.Created).Take(4);     //mporoume na dialeksoume kai allo metric edo
        }
    }
}
